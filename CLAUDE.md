...
- **(2026-09-05)来自 GitHub 的选题额外两条**:① 许可证必须是 permissive 才能内嵌代码;copyleft 项目只准借思路重实现(并在 PLAN.md 写明「未使用其代码」);② BACKLOG 条目标 `[GH:owner/repo]`,让工厂知道有现成参考实现可读(读它的算法/边界处理,不抄它的 UI)。
