...
abstract final class Branding {
  static const String appNameEn = 'Tool Shell';
  static const String appNameZh = 'Tool Shell';
  ...
  static String get aboutText => tr(
        zh: '一个小而专注的工具,完全在你的设备上运行。无账号、无广告,你的数据不出手机。',
        en: 'A small, focused tool that runs entirely on your device. '
